...
echo "Rows: $num_rows ";						//вывод количества строк
...
for ($c=0; $c<$num_rows; $c++)						//цикл, в котором выводится построчно информация из таблицы $result, в виде html-таблицы
    {
        ...
        echo "<tr>";
        echo "<td style='border:1px solid grey'>$f[num_first]</td>";
        echo "<td style='border:1px solid grey'>$f[num_second]</td>";
        echo "<td style='border:1px solid grey'>$f[num_third]</td>";
        echo "<td style='border:1px solid grey'>$f[num_fourth]</td>";
        echo "<td style='border:1px solid grey'>$f[num_fifth]</td>";
        echo "<td style='border:1px solid grey'>$f[num_sixth]</td>";
        echo "</tr>";
    }									//конец цикла
